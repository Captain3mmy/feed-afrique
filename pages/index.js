        ...
        <div className="container mx-auto items-center flex flex-wrap">
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              ...
              Feed Afrique - Digital Agribusiness Investment Solution.
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-blueGray-500">
                  Feed Afrique is a sustainable agritech solution startup that makes real investment in agriculture as easy as few clicks on your digital device. We are fully digitalized and ready for business.
              </p>
              <div className="mt-12">
                <a
          ...
          <div className="flex flex-wrap items-center">
            <div className="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-32">
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-blueGray-700">
                <img
                  alt="..."
                  src="https://images.unsplash.com/photo-1658881070511-c5aa3a883a9b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8bGl2ZXN0b2NrJTIwZmFybWluZ3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=700&q=80"
                ...
                <blockquote className="relative p-8 mb-4">
                  ...
                  <p className="text-md font-light mt-2 text-white">
                    We provide a digital platform for you to invest 
                    in Agribusiness from anywhere in the world and grow
                    wealth with ease.
                  </p>
                </blockquote>
              </div>
                ...
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col min-w-0 mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <h6 className="text-xl mb-1 font-semibold">Renewable Energy Production</h6>
                      <p className="mb-4 text-blueGray-500">
        ...
        <div className="justify-center text-center flex flex-wrap mt-24">
          <div className="w-full md:w-6/12 px-12 md:px-4">
            ...
            <p className="text-lg leading-relaxed mt-4 mb-4 text-blueGray-500">
              Take a quick look at projects we have worked on.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-wrap justify-center bg-white shadow-xl rounded-lg -mt-64 py-16 px-12 relative z-10">
            <div className="w-full text-center lg:w-8/12">
              ...
              <p className="text-blueGray-500 text-lg leading-relaxed mt-4 mb-4">
                Take the step in the right direction now register on our app and get access to all our services.
              </p>
